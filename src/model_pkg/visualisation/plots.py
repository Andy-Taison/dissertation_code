...
def generate_plots(history: TrainingHistory, model_name: str):
    ...
    plot_metrics_vs_epochs(history, "coor_loss", "desc_loss", filename=f"{model_name}/{model_name}_raw_recon_loss_parts_vs_epochs")
    plot_metrics_vs_epochs(history, "scaled_coor_loss", "scaled_desc_loss", filename=f"{model_name}/{model_name}_scaled_recon_loss_parts_vs_epochs")
