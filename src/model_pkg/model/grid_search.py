...
def create_grid() -> list[dict]:
    ...
    grid = [    ########## SCHEDULER IS SET TO NONE BELOW
        ...
        {"batch_size": 64, "latent_dim": 16, "optimizer": {"type": optim.Adam, "params": {}, "model_name": "adam"},
         "lr": 1e-3, "decay": 1e-5, "lambda_coord": 6.0, "lambda_desc": 2.0, "lambda_collapse": 0.5,
         "beta": 0.3, "lambda_reg": 0.001},

        {"batch_size": 64, "latent_dim": 16, "optimizer": {"type": optim.Adam, "params": {}, "model_name": "adam"},
         "lr": 1e-3, "decay": 1e-5, "lambda_coord": 4.0, "lambda_desc": 1.0, "lambda_collapse": 0.3,
         "beta": 0.3, "lambda_reg": 0.001},

        {"batch_size": 64, "latent_dim": 16, "optimizer": {"type": optim.Adam, "params": {}, "model_name": "adam"},
         "lr": 1e-3, "decay": 1e-5, "lambda_coord": 5.0, "lambda_desc": 3.0, "lambda_collapse": 0.5,
         "beta": 0.3, "lambda_reg": 0.001},

        {"batch_size": 64, "latent_dim": 16, "optimizer": {"type": optim.Adam, "params": {}, "model_name": "adam"},
         "lr": 1e-3, "decay": 1e-5, "lambda_coord": 6.0, "lambda_desc": 2.0, "lambda_collapse": 1.0,
         "beta": 0.3, "lambda_reg": 0.001},

        {"batch_size": 64, "latent_dim": 16, "optimizer": {"type": optim.Adam, "params": {}, "model_name": "adam"},
         "lr": 1e-3, "decay": 1e-5, "lambda_coord": 4.5, "lambda_desc": 1.5, "lambda_collapse": 1.0,
         "beta": 0.3, "lambda_reg": 0.001}
    ]
