...
def create_grid() -> list[dict]:
    ...
    grid = [    ########## SCHEDULER IS SET TO NONE BELOW
        ...
        {"batch_size": 64, "latent_dim": 16, "optimizer": {"type": optim.Adam, "params": {}, "model_name": "adam"},
         "lr": 1e-3, "decay": 1e-5, "lambda_coord": 6.0, "lambda_desc": 0.5, "lambda_collapse": 0.3,
         "beta": 0.4, "lambda_reg": 0.001},

        {"batch_size": 64, "latent_dim": 16, "optimizer": {"type": optim.Adam, "params": {}, "model_name": "adam"},
         "lr": 1e-3, "decay": 1e-5, "lambda_coord": 5.0, "lambda_desc": 0.2, "lambda_collapse": 0.3,
         "beta": 0.35, "lambda_reg": 0.001},

        {"batch_size": 64, "latent_dim": 16, "optimizer": {"type": optim.Adam, "params": {}, "model_name": "adam"},
         "lr": 1e-3, "decay": 1e-5, "lambda_coord": 4.0, "lambda_desc": 0.4, "lambda_collapse": 0.5,
         "beta": 0.4, "lambda_reg": 0.001},

        {"batch_size": 64, "latent_dim": 16, "optimizer": {"type": optim.Adam, "params": {}, "model_name": "adam"},
         "lr": 1e-3, "decay": 1e-5, "lambda_coord": 7.0, "lambda_desc": 0.1, "lambda_collapse": 0.5,
         "beta": 0.35, "lambda_reg": 0.001},

        {"batch_size": 64, "latent_dim": 16, "optimizer": {"type": optim.Adam, "params": {}, "model_name": "adam"},
         "lr": 1e-3, "decay": 1e-5, "lambda_coord": 8.0, "lambda_desc": 0.3, "lambda_collapse": 0.3,
         "beta": 0.4, "lambda_reg": 0.001}
    ]
