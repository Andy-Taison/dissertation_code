...
class VaeLoss:
    ...
    def __call__(self, x: torch.Tensor, x_reconstructed: torch.Tensor, z_mean: torch.Tensor, z_log_var: torch.Tensor, transform_matrix: torch.Tensor) -> tuple[torch.Tensor, torch.Tensor]:
        """
